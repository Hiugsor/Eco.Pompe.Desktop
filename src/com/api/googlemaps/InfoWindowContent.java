...
public class InfoWindowContent {
	...
	//String contentString = "<img src=\"https://maps.google.com/mapfiles/ms/icons/blue-dot.png\" ALT=\"missing pics\"><h3>Vous �tes ici</h3><br/> Lat : " + txtLAT.getText() + "<br/> Long : " + txtLONG.getText();
