...
public class Marker {
	...
	{		
		String contentString = "<img src=\"gas-station-red-black.png\" ALT=\"Station\"><h2>Station ID : " + ID + "</h2><br/> Lat : " + lat + "<br/> Long : " + lng + "<br/> Adresse : " + adr + "<br/> CP : " + CP + "<br/> Ville : " + ville.toUpperCase();
		browser.executeJavaScript(
			  ...
			  + "infowindow: myinfowindow,\n"
			  + "title: '" +  ID + "'\n" + "});\n"
			  + "marker.setIcon('\\gas-station-red-black.png');"
			  + "marker.addListener('click', function() {this.infowindow.open(map, this);});"
